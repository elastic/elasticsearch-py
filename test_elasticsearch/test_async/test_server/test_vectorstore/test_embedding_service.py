...
async def test_elasticsearch_embedding_query(async_client: AsyncElasticsearch) -> None:
...
async def test_user_agent_default(
    async_client: AsyncElasticsearch, async_client_request_saving: AsyncElasticsearch
) -> None:
    ...
    embeddings = AsyncElasticsearchEmbeddings(
        client=async_client_request_saving, model_id=MODEL_ID
    )
