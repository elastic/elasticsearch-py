...
class TestVectorStore:
    def test_search_without_metadata(
        self, es_client: Elasticsearch, index: str
    ) -> None:
    ...
    def test_add_vectors(self, es_client: Elasticsearch, index: str) -> None:
        """
    ...
    def test_search_with_metadata(self, es_client: Elasticsearch, index: str) -> None:
    ...
    def test_search_with_filter(self, es_client: Elasticsearch, index: str) -> None:
        """Test end to end construction and search with metadata."""
        store = VectorStore(
            index=index,
            retrieval_strategy=DenseVectorStrategy(),
    ...
    def test_search_script_score(self, es_client: Elasticsearch, index: str) -> None:
        """Test end to end construction and search with metadata."""
        store = VectorStore(
            index=index,
    ...
    def test_search_bm25(self, es_client: Elasticsearch, index: str) -> None:
    ...
    def test_delete(self, es_client: Elasticsearch, index: str) -> None:
    ...
    def test_user_agent_default(
        self, es_client_request_saving: Elasticsearch, index: str
    ) -> None:
    ...
    def test_bulk_args(self, es_client_request_saving: Any, index: str) -> None:
    ...
    def test_metadata_mapping(self, es_client: Elasticsearch, index: str) -> None:
