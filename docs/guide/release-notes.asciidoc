...
- Instrument ping with OTel (https://github.com/elastic/elasticsearch-py/pull/3160[#3160])
- Add warnings for private APIs (https://github.com/elastic/elasticsearch-py/pull/3212[#3212])
- Make positional arguments in DSL generated classes explicit (https://github.com/elastic/elasticsearch-py/pull/3233[#3233])

Bug fixes

- ES|QL query builder: fix missing assignment (https://github.com/elastic/elasticsearch-py/pull/3151[#3151])
- Use relative imports to fix `elasticsearch9` package imports (https://github.com/elastic/elasticsearch-py/pull/3232[#3232])
...
- Add `flush_after_seconds` option to `streaming_bulk()` (https://github.com/elastic/elasticsearch-py/pull/3064[#3064])

### Bug Fixes

- DSL: support passing inner documents as `AttrDict` instances (https://github.com/elastic/elasticsearch-py/pull/3080[#3080])
- DSL: add some recently added field classes as top-level exports for the package (https://github.com/elastic/elasticsearch-py/pull/3078[#3078])
...
- Add 3.14 to CI builds (https://github.com/elastic/elasticsearch-py/pull/3103[#3103])
