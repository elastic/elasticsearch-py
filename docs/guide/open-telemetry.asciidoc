...
This section discusses configuration of the OpenTelemetry instrumentation itself.
To get started with OpenTelemetry instrumentation in general, you can instead refer to the https://opentelemetry.io/docs/languages/python/[Python OpenTelemetry documentation] or to the following step-by-step blog posts:
