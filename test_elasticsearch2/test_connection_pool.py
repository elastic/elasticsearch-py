...
from elasticsearch2.connection_pool import ConnectionPool, RoundRobinSelector, DummyConnectionPool
from elasticsearch2.exceptions import ImproperlyConfigured
