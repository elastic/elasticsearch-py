...
from elasticsearch2 import helpers, Elasticsearch
from elasticsearch2.serializer import JSONSerializer

from .test_cases import TestCase

class TestParallelBulk(TestCase):
    @mock.patch('elasticsearch2.helpers._process_bulk_chunk', return_value=[])
    ...
    @mock.patch(
        'elasticsearch2.helpers._process_bulk_chunk',
