...
class SearchableSnapshotsClient(NamespacedClient):
    ...
    def clear_cache(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/searchable-snapshots-apis.html>`_
    ...
    def mount(self, repository, snapshot, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/searchable-snapshots-api-mount-snapshot.html>`_
