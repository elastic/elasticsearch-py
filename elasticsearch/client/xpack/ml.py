...
class MlClient(NamespacedClient):
    ...
    def delete_calendar(self, calendar_id, params=None):
        ...
        return self.transport.perform_request(
            "DELETE",
            _make_path("_xpack", "ml", "calendars", calendar_id),
            params=params,
        )
    ...
    def delete_calendar_event(self, calendar_id, event_id, params=None):
        ...
        return self.transport.perform_request(
            "DELETE",
            _make_path("_xpack", "ml", "calendars", calendar_id, "events", event_id),
            params=params,
        )
    ...
    def delete_calendar_job(self, calendar_id, job_id, params=None):
        ...
        return self.transport.perform_request(
            "DELETE",
            _make_path("_xpack", "ml", "calendars", calendar_id, "jobs", job_id),
            params=params,
        )
    ...
    def find_file_structure(self, body, params=None):
        """
        `<http://www.elastic.co/guide/en/elasticsearch/reference/6.7/ml-find-file-structure.html>`_
    ...
    def get_calendar_events(self, calendar_id, params=None):
        ...
        return self.transport.perform_request(
            "GET",
            _make_path("_xpack", "ml", "calendars", calendar_id, "events"),
            params=params,
        )

    @query_params("from_", "size")
    def get_calendars(self, calendar_id=None, params=None):
        """
        `<>`_
        ...
        """
        return self.transport.perform_request(
            "GET", _make_path("_xpack", "ml", "calendars", calendar_id), params=params
        )
    ...
    def info(self, params=None):
        ...
        `<>`_
        """
        return self.transport.perform_request("GET", "/_xpack/ml/info", params=params)
    ...
    def set_upgrade_mode(self, params=None):
        ...
        """
        return self.transport.perform_request(
            "POST", "/_xpack/ml/set_upgrade_mode", params=params
        )
    ...
    def update_filter(self, filter_id, body, params=None):
        ...
        return self.transport.perform_request(
            "POST",
            _make_path("_xpack", "ml", "filters", filter_id, "_update"),
            params=params,
            body=body,
        )
