...
class IlmClient(NamespacedClient):
    ...
    def delete_lifecycle(self, policy, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-delete-lifecycle.html>`_
    ...
    def explain_lifecycle(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-explain-lifecycle.html>`_
    ...
    def get_lifecycle(self, policy=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-get-lifecycle.html>`_
    ...
    def get_status(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-get-status.html>`_
        """
        return self.transport.perform_request(
    ...
    def move_to_step(self, index, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-move-to-step.html>`_
    ...
    def put_lifecycle(self, policy, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-put-lifecycle.html>`_
    ...
    def remove_policy(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-remove-policy.html>`_
    ...
    def retry(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-retry-policy.html>`_
    ...
    def start(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-start.html>`_
        """
        return self.transport.perform_request(
    ...
    def stop(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-stop.html>`_
        """
        return self.transport.perform_request(
    ...
    def migrate_to_data_tiers(self, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/ilm-migrate-to-data-tiers.html>`_
