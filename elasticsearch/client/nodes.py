...
class NodesClient(NamespacedClient):
    ...
    def reload_secure_settings(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/secure-settings.html#reloadable-secure-settings>`_
    ...
    def info(self, node_id=None, metric=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/cluster-nodes-info.html>`_
    ...
    def stats(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/cluster-nodes-stats.html>`_
    ...
    def hot_threads(self, node_id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/cluster-nodes-hot-threads.html>`_
    ...
    def usage(self, node_id=None, metric=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/cluster-nodes-usage.html>`_
