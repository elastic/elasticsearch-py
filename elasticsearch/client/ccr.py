...
class CcrClient(NamespacedClient):
    ...
    def delete_auto_follow_pattern(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-delete-auto-follow-pattern.html>`_
    ...
    def follow(self, index, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-put-follow.html>`_
    ...
    def follow_info(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-get-follow-info.html>`_
    ...
    def follow_stats(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-get-follow-stats.html>`_
    ...
    def forget_follower(self, index, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-post-forget-follower.html>`_
    ...
    def get_auto_follow_pattern(self, name=None, params=None, headers=None):
        ...
        collection.
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-get-auto-follow-pattern.html>`_
    ...
    def pause_follow(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-post-pause-follow.html>`_
    ...
    def put_auto_follow_pattern(self, name, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-put-auto-follow-pattern.html>`_
    ...
    def resume_follow(self, index, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-post-resume-follow.html>`_
    ...
    def stats(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-get-stats.html>`_
        """
        return self.transport.perform_request(
    ...
    def unfollow(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-post-unfollow.html>`_
    ...
    def pause_auto_follow_pattern(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-pause-auto-follow-pattern.html>`_
    ...
    def resume_auto_follow_pattern(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.9/ccr-resume-auto-follow-pattern.html>`_
