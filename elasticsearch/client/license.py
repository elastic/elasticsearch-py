...
class LicenseClient(NamespacedClient):
    ...
    def delete(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/delete-license.html>`_
        """
    ...
    def get(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/get-license.html>`_
    ...
    def get_basic_status(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/get-basic-status.html>`_
        """
        return self.transport.perform_request(
    ...
    def get_trial_status(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/get-trial-status.html>`_
        """
        return self.transport.perform_request(
    ...
    def post(self, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/update-license.html>`_
    ...
    def post_start_basic(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/start-basic.html>`_
    ...
    def post_start_trial(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/start-trial.html>`_
