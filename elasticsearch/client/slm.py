...
class SlmClient(NamespacedClient):
    ...
    def delete_lifecycle(self, policy_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-delete-policy.html>`_
    ...
    def execute_lifecycle(self, policy_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-execute-lifecycle.html>`_
    ...
    def execute_retention(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-execute-retention.html>`_
        """
        return self.transport.perform_request(
    ...
    def get_lifecycle(self, policy_id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-get-policy.html>`_
    ...
    def get_stats(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-get-stats.html>`_
        """
        return self.transport.perform_request(
    ...
    def put_lifecycle(self, policy_id, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-put-policy.html>`_
    ...
    def get_status(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-get-status.html>`_
        """
        return self.transport.perform_request(
    ...
    def start(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-start.html>`_
        """
        return self.transport.perform_request(
    ...
    def stop(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/slm-api-stop.html>`_
        """
        return self.transport.perform_request(
