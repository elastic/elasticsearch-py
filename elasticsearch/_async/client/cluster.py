...
class ClusterClient(NamespacedClient):
    ...
    async def health(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-health.html>`_
    ...
    async def pending_tasks(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-pending.html>`_
    ...
    async def state(self, metric=None, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-state.html>`_
    ...
    async def stats(self, node_id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-stats.html>`_
    ...
    async def reroute(self, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-reroute.html>`_
    ...
    async def get_settings(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-get-settings.html>`_
    ...
    async def put_settings(self, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-update-settings.html>`_
    ...
    async def remote_info(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-remote-info.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def allocation_explain(self, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/cluster-allocation-explain.html>`_
    ...
    async def delete_component_template(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/indices-component-template.html>`_
    ...
    async def delete_voting_config_exclusions(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/voting-config-exclusions.html>`_
