...
class ClusterClient(NamespacedClient):
    ...
    async def allocation_explain(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-allocation-explain.html>`_
    ...
    async def delete_component_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/indices-component-template.html>`_
    ...
    async def delete_voting_config_exclusions(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/voting-config-exclusions.html>`_
    ...
    async def get_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-get-settings.html>`_
    ...
    async def health(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-health.html>`_
    ...
    async def pending_tasks(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-pending.html>`_
    ...
    async def put_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-update-settings.html>`_
    ...
    async def remote_info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-remote-info.html>`_
        """
        __path = "/_remote/info"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    async def reroute(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-reroute.html>`_
    ...
    async def state(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-state.html>`_
    ...
    async def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-stats.html>`_
