...
class TransformClient(NamespacedClient):
    ...
    async def delete_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/delete-transform.html>`_
    ...
    async def get_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/get-transform.html>`_
    ...
    async def get_transform_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/get-transform-stats.html>`_
    ...
    async def preview_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/preview-transform.html>`_
    ...
    async def put_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/put-transform.html>`_
    ...
    async def reset_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/reset-transform.html>`_
    ...
    async def schedule_now_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/schedule-now-transform.html>`_
    ...
    async def start_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/start-transform.html>`_
    ...
    async def stop_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/stop-transform.html>`_
    ...
    async def update_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/update-transform.html>`_
    ...
    async def upgrade_transforms(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.9/upgrade-transforms.html>`_
