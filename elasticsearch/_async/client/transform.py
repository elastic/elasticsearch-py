...
class TransformClient(NamespacedClient):
    ...
    async def delete_transform(self, transform_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/delete-transform.html>`_
    ...
    async def get_transform(self, transform_id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/get-transform.html>`_
    ...
    async def get_transform_stats(self, transform_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/get-transform-stats.html>`_
    ...
    async def preview_transform(self, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/preview-transform.html>`_
    ...
    async def put_transform(self, transform_id, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/put-transform.html>`_
    ...
    async def start_transform(self, transform_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/start-transform.html>`_
    ...
    async def stop_transform(self, transform_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/stop-transform.html>`_
    ...
    async def update_transform(self, transform_id, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/update-transform.html>`_
