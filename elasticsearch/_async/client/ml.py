...
class MlClient(NamespacedClient):
    ...
    async def close_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-close-job.html>`_
    ...
    async def delete_calendar(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-calendar.html>`_
    ...
    async def delete_calendar_event(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-calendar-event.html>`_
    ...
    async def delete_calendar_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-calendar-job.html>`_
    ...
    async def delete_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/delete-dfanalytics.html>`_
    ...
    async def delete_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-datafeed.html>`_
    ...
    async def delete_expired_data(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-expired-data.html>`_
    ...
    async def delete_filter(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-filter.html>`_
    ...
    async def delete_forecast(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-forecast.html>`_
    ...
    async def delete_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-job.html>`_
    ...
    async def delete_model_snapshot(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-delete-snapshot.html>`_
    ...
    async def delete_trained_model(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/delete-trained-models.html>`_
    ...
    async def delete_trained_model_alias(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/delete-trained-models-aliases.html>`_
    ...
    async def estimate_model_memory(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-apis.html>`_
    ...
    async def evaluate_data_frame(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/evaluate-dfanalytics.html>`_
    ...
    async def explain_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/explain-dfanalytics.html>`_
    ...
    async def flush_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-flush-job.html>`_
    ...
    async def forecast(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-forecast.html>`_
    ...
    async def get_buckets(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-bucket.html>`_
    ...
    async def get_calendar_events(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-calendar-event.html>`_
    ...
    async def get_calendars(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-calendar.html>`_
    ...
    async def get_categories(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-category.html>`_
    ...
    async def get_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-dfanalytics.html>`_
    ...
    async def get_data_frame_analytics_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-dfanalytics-stats.html>`_
    ...
    async def get_datafeed_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-datafeed-stats.html>`_
    ...
    async def get_datafeeds(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-datafeed.html>`_
    ...
    async def get_filters(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-filter.html>`_
    ...
    async def get_influencers(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-influencer.html>`_
    ...
    async def get_job_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-job-stats.html>`_
    ...
    async def get_jobs(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-job.html>`_
    ...
    async def get_memory_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-ml-memory.html>`_
    ...
    async def get_model_snapshots(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-snapshot.html>`_
    ...
    async def get_overall_buckets(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-overall-buckets.html>`_
    ...
    async def get_records(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-get-record.html>`_
    ...
    async def get_trained_models(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-trained-models.html>`_
    ...
    async def get_trained_models_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-trained-models-stats.html>`_
    ...
    async def infer_trained_model_deployment(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/infer-trained-model-deployment.html>`_
    ...
    async def info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-ml-info.html>`_
        """
        __path = "/_ml/info"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    async def open_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-open-job.html>`_
    ...
    async def post_calendar_events(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-post-calendar-event.html>`_
    ...
    async def post_data(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-post-data.html>`_
    ...
    async def preview_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/preview-dfanalytics.html>`_
    ...
    async def preview_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-preview-datafeed.html>`_
    ...
    async def put_calendar(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-put-calendar.html>`_
    ...
    async def put_calendar_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-put-calendar-job.html>`_
    ...
    async def put_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/put-dfanalytics.html>`_
    ...
    async def put_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-put-datafeed.html>`_
    ...
    async def put_filter(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-put-filter.html>`_
    ...
    async def put_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-put-job.html>`_
    ...
    async def put_trained_model(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/put-trained-models.html>`_
    ...
    async def put_trained_model_alias(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/put-trained-models-aliases.html>`_
    ...
    async def put_trained_model_definition_part(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/put-trained-model-definition-part.html>`_
    ...
    async def put_trained_model_vocabulary(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/put-trained-model-vocabulary.html>`_
    ...
    async def reset_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-reset-job.html>`_
    ...
    async def revert_model_snapshot(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-revert-snapshot.html>`_
    ...
    async def set_upgrade_mode(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-set-upgrade-mode.html>`_
    ...
    async def start_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/start-dfanalytics.html>`_
    ...
    async def start_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-start-datafeed.html>`_
    ...
    async def start_trained_model_deployment(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/start-trained-model-deployment.html>`_
    ...
    async def stop_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/stop-dfanalytics.html>`_
    ...
    async def stop_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-stop-datafeed.html>`_
    ...
    async def stop_trained_model_deployment(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/stop-trained-model-deployment.html>`_
    ...
    async def update_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/update-dfanalytics.html>`_
    ...
    async def update_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-update-datafeed.html>`_
    ...
    async def update_filter(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-update-filter.html>`_
    ...
    async def update_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-update-job.html>`_
    ...
    async def update_model_snapshot(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-update-snapshot.html>`_
    ...
    async def upgrade_job_snapshot(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/ml-upgrade-job-model-snapshot.html>`_
    ...
    async def validate(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/machine-learning/8.2/ml-jobs.html>`_
