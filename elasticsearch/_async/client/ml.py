    ...
    async def info(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Return ML defaults and limits.
    ...
    async def put_data_frame_analytics(
        ...
        *,
        ...
        .. raw:: html
          ...
          source indices and stores the outcome in a destination index.</p>
    ...
    async def put_datafeed(
        ...
        *,
        ...
        .. raw:: html
          ...
          If you are concerned about delayed data, you can add a delay (<code>query_delay') at each interval. When Elasticsearch security features are enabled, your datafeed remembers which roles the user who created it had at the time of creation and runs the query using those same roles. If you provide secondary authorization headers, those credentials are used instead. You must use Kibana, this API, or the create anomaly detection jobs API to create a datafeed. Do not add a datafeed directly to the </code>.ml-config<code>index. Do not give users</code>write<code>privileges on the</code>.ml-config` index.</p>
    ...
    async def put_job(
        ...
        *,
        ...
        .. raw:: html
          ...
          If you include a <code>datafeed_config</code>, you must have read index privileges on the source index.</p>
    ...
    async def validate(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Validates an anomaly detection job.</p>
    ...
    async def validate_detector(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Validates an anomaly detection detector.</p>
