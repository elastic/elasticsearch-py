...
class CcrClient(NamespacedClient):
    ...
    async def delete_auto_follow_pattern(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-delete-auto-follow-pattern.html>`_
    ...
    async def follow(self, index, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-put-follow.html>`_
    ...
    async def follow_info(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-get-follow-info.html>`_
    ...
    async def follow_stats(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-get-follow-stats.html>`_
    ...
    async def forget_follower(self, index, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-post-forget-follower.html>`_
    ...
    async def get_auto_follow_pattern(self, name=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-get-auto-follow-pattern.html>`_
    ...
    async def pause_follow(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-post-pause-follow.html>`_
    ...
    async def put_auto_follow_pattern(self, name, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-put-auto-follow-pattern.html>`_
    ...
    async def resume_follow(self, index, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-post-resume-follow.html>`_
    ...
    async def stats(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-get-stats.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def unfollow(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-post-unfollow.html>`_
    ...
    async def pause_auto_follow_pattern(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-pause-auto-follow-pattern.html>`_
    ...
    async def resume_auto_follow_pattern(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/ccr-resume-auto-follow-pattern.html>`_
