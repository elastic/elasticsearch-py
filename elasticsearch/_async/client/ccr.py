...
class CcrClient(NamespacedClient):
    ...
    async def delete_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-delete-auto-follow-pattern.html>`_
    ...
    async def follow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-put-follow.html>`_
    ...
    async def follow_info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-get-follow-info.html>`_
    ...
    async def follow_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-get-follow-stats.html>`_
    ...
    async def forget_follower(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-post-forget-follower.html>`_
    ...
    async def get_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-get-auto-follow-pattern.html>`_
    ...
    async def pause_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-pause-auto-follow-pattern.html>`_
    ...
    async def pause_follow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-post-pause-follow.html>`_
    ...
    async def put_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-put-auto-follow-pattern.html>`_
    ...
    async def resume_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-resume-auto-follow-pattern.html>`_
    ...
    async def resume_follow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-post-resume-follow.html>`_
    ...
    async def unfollow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.0/ccr-post-unfollow.html>`_
