...
class EnrichClient(NamespacedClient):
    ...
    async def delete_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/delete-enrich-policy-api.html>`_
    ...
    async def execute_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/execute-enrich-policy-api.html>`_
    ...
    async def get_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-enrich-policy-api.html>`_
    ...
    async def put_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/put-enrich-policy-api.html>`_
    ...
    async def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/enrich-stats-api.html>`_
        """
