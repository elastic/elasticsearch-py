...
class EnrichClient(NamespacedClient):
    ...
    async def delete_policy(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/delete-enrich-policy-api.html>`_
    ...
    async def execute_policy(self, name, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/execute-enrich-policy-api.html>`_
    ...
    async def get_policy(self, name=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/get-enrich-policy-api.html>`_
    ...
    async def put_policy(self, name, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/put-enrich-policy-api.html>`_
    ...
    async def stats(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/enrich-stats-api.html>`_
        """
        return await self.transport.perform_request(
