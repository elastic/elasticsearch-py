...
class AsyncElasticsearch(object):
    ...
    async def mget(self, body, index=None, doc_type=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/docs-multi-get.html>`_
    ...
    async def msearch(self, body, index=None, doc_type=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/search-multi-search.html>`_
    ...
    async def mtermvectors(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/docs-multi-termvectors.html>`_
    ...
    async def rank_eval(self, body, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/search-rank-eval.html>`_
    ...
    async def reindex(self, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/docs-reindex.html>`_
    ...
    async def render_search_template(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/render-search-template-api.html>`_
    ...
    async def scroll(self, body=None, scroll_id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/search-request-body.html#request-body-search-scroll>`_
    ...
    async def search(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/search-search.html>`_
    ...
    async def search_shards(self, index=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/search-shards.html>`_
    ...
    async def search_template(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/search-template.html>`_
    ...
    async def termvectors(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/docs-termvectors.html>`_
    ...
    async def update(self, index, id, body, doc_type=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/docs-update.html>`_
    ...
    async def update_by_query(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/docs-update-by-query.html>`_
    ...
    async def close_point_in_time(self, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/point-in-time-api.html>`_
    ...
    async def terms_enum(self, index, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.14/search-terms-enum.html>`_
