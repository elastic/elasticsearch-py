...
class AsyncElasticsearch(BaseClient):
    ...
    async def bulk(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-bulk.html>`_
    ...
    async def clear_scroll(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/clear-scroll-api.html>`_
    ...
    async def close_point_in_time(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/point-in-time-api.html>`_
    ...
    async def count(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-count.html>`_
    ...
    async def create(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-index_.html>`_
    ...
    async def delete(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-delete.html>`_
    ...
    async def delete_by_query(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-delete-by-query.html>`_
    ...
    async def delete_script(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/modules-scripting.html>`_
    ...
    async def exists(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-get.html>`_
    ...
    async def explain(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-explain.html>`_
    ...
    async def field_caps(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-field-caps.html>`_
    ...
    async def get_script_context(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/painless/8.5/painless-contexts.html>`_
        """
    ...
    async def info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/index.html>`_
        """
        __path = "/"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    async def knn_search(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-search.html>`_
    ...
    async def mget(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-multi-get.html>`_
    ...
    async def msearch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-multi-search.html>`_
    ...
    async def mtermvectors(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-multi-termvectors.html>`_
    ...
    async def rank_eval(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-rank-eval.html>`_
    ...
    async def reindex(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-reindex.html>`_
    ...
    async def render_search_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/render-search-template-api.html>`_
    ...
    async def scripts_painless_execute(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/painless/8.5/painless-execute-api.html>`_
    ...
    async def scroll(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-request-body.html#request-body-search-scroll>`_
    ...
    async def search_mvt(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-vector-tile-api.html>`_
    ...
    async def search_shards(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-shards.html>`_
    ...
    async def search_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-template.html>`_
    ...
    async def terms_enum(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/search-terms-enum.html>`_
    ...
    async def termvectors(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-termvectors.html>`_
    ...
    async def update(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-update.html>`_
    ...
    async def update_by_query(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/docs-update-by-query.html>`_
