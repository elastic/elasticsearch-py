...
class WatcherClient(NamespacedClient):
    ...
    async def ack_watch(self, watch_id, action_id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-ack-watch.html>`_
    ...
    async def activate_watch(self, watch_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-activate-watch.html>`_
    ...
    async def deactivate_watch(self, watch_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-deactivate-watch.html>`_
    ...
    async def delete_watch(self, id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-delete-watch.html>`_
    ...
    async def execute_watch(self, body=None, id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-execute-watch.html>`_
    ...
    async def get_watch(self, id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-get-watch.html>`_
    ...
    async def put_watch(self, id, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-put-watch.html>`_
    ...
    async def start(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-start.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def stats(self, metric=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-stats.html>`_
    ...
    async def stop(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-stop.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def query_watches(self, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.15/watcher-api-query-watches.html>`_
