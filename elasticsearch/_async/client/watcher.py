...
class WatcherClient(NamespacedClient):
    ...
    async def ack_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-ack-watch.html>`_
    ...
    async def activate_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-activate-watch.html>`_
    ...
    async def deactivate_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-deactivate-watch.html>`_
    ...
    async def delete_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-delete-watch.html>`_
    ...
    async def execute_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-execute-watch.html>`_
    ...
    async def get_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-get-watch.html>`_
    ...
    async def put_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-put-watch.html>`_
    ...
    async def query_watches(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-query-watches.html>`_
    ...
    async def start(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-start.html>`_
        """
    ...
    async def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-stats.html>`_
    ...
    async def stop(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/watcher-api-stop.html>`_
        """
