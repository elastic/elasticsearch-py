...
class AsyncElasticsearch(object):
    ...
    async def create(
        ...
        *,
        ...
        wait_for_active_shards: Optional[
            Union[Union[Literal["all", "index-setting"], str], int]
        ] = ...,
        pretty: Optional[bool] = ...,
        human: Optional[bool] = ...,
        error_trace: Optional[bool] = ...,
    ...
    async def search(
        ...
        *,
        ...
        _source_excludes: Optional[Any] = ...,
        _source_includes: Optional[Any] = ...,
        aggregations: Optional[Mapping[Any, Mapping[str, Any]]] = ...,
        aggs: Optional[Mapping[Any, Mapping[str, Any]]] = ...,
        ...
        rest_total_hits_as_int: Optional[Any] = ...,
        routing: Optional[Any] = ...,
        runtime_mappings: Optional[Mapping[Any, Mapping[str, Any]]] = ...,
        script_fields: Optional[Mapping[Any, Mapping[str, Any]]] = ...,
        scroll: Optional[Any] = ...,
    ...
    async def update(
        ...
        *,
        ...
        _source_excludes: Optional[Any] = ...,
        _source_includes: Optional[Any] = ...,
        detect_noop: Optional[Any] = ...,
        doc: Optional[Any] = ...,
        doc_as_upsert: Optional[Any] = ...,
        if_primary_term: Optional[int] = ...,
        if_seq_no: Optional[int] = ...,
        lang: Optional[Any] = ...,
        refresh: Optional[Union[Literal["false", "true", "wait_for"], bool, str]] = ...,
