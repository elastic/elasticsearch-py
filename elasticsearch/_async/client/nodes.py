...
class NodesClient(NamespacedClient):
    ...
    async def clear_repositories_metering_archive(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/clear-repositories-metering-archive-api.html>`_
    ...
    async def get_repositories_metering_info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/get-repositories-metering-api.html>`_
    ...
    async def hot_threads(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-nodes-hot-threads.html>`_
    ...
    async def info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-nodes-info.html>`_
    ...
    async def reload_secure_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/secure-settings.html#reloadable-secure-settings>`_
    ...
    async def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-nodes-stats.html>`_
    ...
    async def usage(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/cluster-nodes-usage.html>`_
