...
class CatClient(NamespacedClient):
    ...
    async def aliases(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-alias.html>`_
    ...
    async def allocation(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-allocation.html>`_
    ...
    async def component_templates(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-compoentn-templates.html>`_
    ...
    async def count(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-count.html>`_
    ...
    async def fielddata(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-fielddata.html>`_
    ...
    async def health(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-health.html>`_
    ...
    async def help(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat.html>`_
    ...
    async def indices(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-indices.html>`_
    ...
    async def master(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-master.html>`_
    ...
    async def ml_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-dfanalytics.html>`_
    ...
    async def ml_datafeeds(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-datafeeds.html>`_
    ...
    async def ml_jobs(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-anomaly-detectors.html>`_
    ...
    async def ml_trained_models(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-trained-model.html>`_
    ...
    async def nodeattrs(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-nodeattrs.html>`_
    ...
    async def nodes(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-nodes.html>`_
    ...
    async def pending_tasks(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-pending-tasks.html>`_
    ...
    async def plugins(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-plugins.html>`_
    ...
    async def recovery(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-recovery.html>`_
    ...
    async def repositories(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-repositories.html>`_
    ...
    async def segments(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-segments.html>`_
    ...
    async def shards(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-shards.html>`_
    ...
    async def snapshots(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-snapshots.html>`_
    ...
    async def tasks(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/tasks.html>`_
    ...
    async def templates(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-templates.html>`_
    ...
    async def thread_pool(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-thread-pool.html>`_
    ...
    async def transforms(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/cat-transforms.html>`_
