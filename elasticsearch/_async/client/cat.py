    ...
    async def aliases(
        ...
        *,
        ...
        .. raw:: html
          ...
          The API does not return data stream aliases.</p>
    ...
    async def allocation(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Provides a snapshot of the number of shards allocated to each data node and their disk space.
    ...
    async def fielddata(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns the amount of heap memory currently used by the field data cache on every data node in the cluster.
    ...
    async def health(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns the health status of a cluster, similar to the cluster health API.
          IMPORTANT: cat APIs are only intended for human consumption using the command line or Kibana console.
    ...
    async def help(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Get CAT help.
          Returns help for the CAT APIs.</p>
    ...
    async def indices(
        ...
        *,
        ...
        .. raw:: html
          ...
          Returns high-level information about indices in a cluster, including backing indices for data streams.</p>
    ...
    async def master(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns information about the master node, including the ID, bound IP address, and name.
    ...
    async def ml_data_frame_analytics(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Get data frame analytics jobs.
          Returns configuration and usage information about data frame analytics jobs.</p>
    ...
    async def ml_trained_models(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Get trained models.
          Returns configuration and usage information about inference trained models.</p>
          <p>CAT APIs are only intended for human consumption using the Kibana
          console or command line. They are not intended for use by applications. For
    ...
    async def nodeattrs(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns information about custom node attributes.
          IMPORTANT: cat APIs are only intended for human consumption using the command line or Kibana console. They are not intended for use by applications. For application consumption, use the nodes info API.</p>
    ...
    async def nodes(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns information about the nodes in a cluster.
          IMPORTANT: cat APIs are only intended for human consumption using the command line or Kibana console. They are not intended for use by applications. For application consumption, use the nodes info API.</p>
    ...
    async def pending_tasks(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns cluster-level changes that have not yet been executed.
    ...
    async def plugins(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns a list of plugins running on each node of a cluster.
          IMPORTANT: cat APIs are only intended for human consumption using the command line or Kibana console. They are not intended for use by applications. For application consumption, use the nodes info API.</p>
    ...
    async def repositories(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns the snapshot repositories for a cluster.
    ...
    async def shards(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns information about the shards in a cluster.
          For data streams, the API returns information about the backing indices.
          IMPORTANT: cat APIs are only intended for human consumption using the command line or Kibana console. They are not intended for use by applications.</p>
    ...
    async def snapshots(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns information about the snapshots stored in one or more repositories.
    ...
    async def tasks(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns information about tasks currently executing in the cluster.
    ...
    async def templates(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns information about index templates in a cluster.
    ...
    async def thread_pool(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Returns thread pool statistics for each node in a cluster.
    ...
    async def transforms(
        ...
        *,
        ...
        .. raw:: html
          ...
          <p>Get transforms.
          Returns configuration and usage information about transforms.</p>
          <p>CAT APIs are only intended for human consumption using the Kibana
          console or command line. They are not intended for use by applications. For
