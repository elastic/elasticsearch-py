...
class MigrationClient(NamespacedClient):
    ...
    async def deprecations(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/migration-api-deprecation.html>`_
    ...
    async def get_feature_upgrade_status(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/migration-api-feature-upgrade.html>`_
        """
