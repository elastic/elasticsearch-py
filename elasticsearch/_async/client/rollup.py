...
class RollupClient(NamespacedClient):
    ...
    async def delete_job(self, id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-delete-job.html>`_
    ...
    async def get_jobs(self, id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-get-job.html>`_
    ...
    async def get_rollup_caps(self, id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-get-rollup-caps.html>`_
    ...
    async def get_rollup_index_caps(self, index, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-get-rollup-index-caps.html>`_
    ...
    async def put_job(self, id, body, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-put-job.html>`_
    ...
    async def rollup_search(
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-search.html>`_
    ...
    async def start_job(self, id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-start-job.html>`_
    ...
    async def stop_job(self, id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.11/rollup-stop-job.html>`_
