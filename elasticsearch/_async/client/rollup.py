...
class RollupClient(NamespacedClient):
    ...
    async def delete_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-delete-job.html>`_
    ...
    async def get_jobs(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-get-job.html>`_
    ...
    async def get_rollup_caps(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-get-rollup-caps.html>`_
    ...
    async def get_rollup_index_caps(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-get-rollup-index-caps.html>`_
    ...
    async def put_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-put-job.html>`_
    ...
    async def rollup(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/xpack-rollup.html>`_
    ...
    async def rollup_search(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-search.html>`_
    ...
    async def start_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-start-job.html>`_
    ...
    async def stop_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/rollup-stop-job.html>`_
