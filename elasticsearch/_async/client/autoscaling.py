...
class AutoscalingClient(NamespacedClient):
    ...
    async def delete_autoscaling_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/autoscaling-delete-autoscaling-policy.html>`_
    ...
    async def get_autoscaling_capacity(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/autoscaling-get-autoscaling-capacity.html>`_
        """
    ...
    async def put_autoscaling_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/autoscaling-put-autoscaling-policy.html>`_
