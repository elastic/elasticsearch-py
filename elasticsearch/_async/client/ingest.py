...
class IngestClient(NamespacedClient):
    ...
    async def delete_pipeline(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/delete-pipeline-api.html>`_
    ...
    async def geo_ip_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/geoip-stats-api.html>`_
        """
    ...
    async def get_pipeline(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/get-pipeline-api.html>`_
    ...
    async def processor_grok(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/grok-processor.html#grok-processor-rest-get>`_
        """
    ...
    async def put_pipeline(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/put-pipeline-api.html>`_
    ...
    async def simulate(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.5/simulate-pipeline-api.html>`_
