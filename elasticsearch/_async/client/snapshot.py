...
class SnapshotClient(NamespacedClient):
    ...
    async def cleanup_repository(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/clean-up-snapshot-repo-api.html>`_
    ...
    async def clone(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/modules-snapshots.html>`_
