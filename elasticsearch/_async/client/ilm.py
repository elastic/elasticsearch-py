...
class IlmClient(NamespacedClient):
    ...
    async def delete_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-delete-lifecycle.html>`_
    ...
    async def explain_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-explain-lifecycle.html>`_
    ...
    async def get_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-get-lifecycle.html>`_
    ...
    async def get_status(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-get-status.html>`_
        """
        __path = "/_ilm/status"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    async def migrate_to_data_tiers(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-migrate-to-data-tiers.html>`_
    ...
    async def move_to_step(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-move-to-step.html>`_
    ...
    async def put_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-put-lifecycle.html>`_
    ...
    async def remove_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-remove-policy.html>`_
    ...
    async def retry(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-retry-policy.html>`_
    ...
    async def start(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-start.html>`_
    ...
    async def stop(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/ilm-stop.html>`_
