...
class SlmClient(NamespacedClient):
    ...
    async def delete_lifecycle(self, policy_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-delete-policy.html>`_
    ...
    async def execute_lifecycle(self, policy_id, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-execute-lifecycle.html>`_
    ...
    async def execute_retention(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-execute-retention.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def get_lifecycle(self, policy_id=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-get-policy.html>`_
    ...
    async def get_stats(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-get-stats.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def put_lifecycle(self, policy_id, body=None, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-put-policy.html>`_
    ...
    async def get_status(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-get-status.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def start(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-start.html>`_
        """
        return await self.transport.perform_request(
    ...
    async def stop(self, params=None, headers=None):
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/7.12/slm-api-stop.html>`_
        """
        return await self.transport.perform_request(
