...
class SearchableSnapshotsClient(NamespacedClient):
    ...
    async def cache_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/searchable-snapshots-apis.html>`_
    ...
    async def mount(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/searchable-snapshots-api-mount-snapshot.html>`_
