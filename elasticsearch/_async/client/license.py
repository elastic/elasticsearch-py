...
class LicenseClient(NamespacedClient):
    ...
    async def delete(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/delete-license.html>`_
        """
        __path = "/_license"
    ...
    async def get(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-license.html>`_
    ...
    async def get_basic_status(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-basic-status.html>`_
        """
    ...
    async def get_trial_status(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/get-trial-status.html>`_
        """
    ...
    async def post(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/update-license.html>`_
    ...
    async def post_start_basic(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/start-basic.html>`_
    ...
    async def post_start_trial(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/start-trial.html>`_
