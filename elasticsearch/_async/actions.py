...
from ..helpers.actions import expand_action, _chunk_actions
...
async def async_reindex(
    ...
    async def _change_doc_index(index):
    ...
    return await async_bulk(
        target_client,
        _change_doc_index(target_index).__aiter__(),
