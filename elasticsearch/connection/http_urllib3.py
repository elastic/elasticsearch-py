...
class Urllib3HttpConnection(Connection):
    ...
    :arg assert_hostname: use hostname verification if not `False`
    :arg assert_fingerprint: verify the supplied certificate fingerprint if not `None`
    ...
    def __init__(self, host='localhost', port=9200, http_auth=None,
        ...
        if use_ssl:
            ...
            kw['assert_fingerprint'] = assert_fingerprint
