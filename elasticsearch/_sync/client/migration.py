...
class MigrationClient(NamespacedClient):
    ...
    def deprecations(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.19/migration-api-deprecation.html>`_
    ...
    def get_feature_upgrade_status(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.19/feature-migration-api.html>`_
        """
        __path_parts: t.Dict[str, str] = {}
