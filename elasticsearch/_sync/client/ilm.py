...
class IlmClient(NamespacedClient):
    ...
    def delete_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-delete-lifecycle.html>`_
    ...
    def explain_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-explain-lifecycle.html>`_
    ...
    def get_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-get-lifecycle.html>`_
    ...
    def get_status(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-get-status.html>`_
        """
        __path = "/_ilm/status"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    def migrate_to_data_tiers(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-migrate-to-data-tiers.html>`_
    ...
    def move_to_step(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-move-to-step.html>`_
    ...
    def put_lifecycle(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-put-lifecycle.html>`_
    ...
    def remove_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-remove-policy.html>`_
    ...
    def retry(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-retry-policy.html>`_
    ...
    def start(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-start.html>`_
    ...
    def stop(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ilm-stop.html>`_
