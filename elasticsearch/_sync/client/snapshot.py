...
class SnapshotClient(NamespacedClient):
    ...
    def cleanup_repository(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/clean-up-snapshot-repo-api.html>`_
    ...
    def clone(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/modules-snapshots.html>`_
