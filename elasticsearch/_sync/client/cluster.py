...
class ClusterClient(NamespacedClient):
    ...
    def allocation_explain(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-allocation-explain.html>`_
    ...
    def delete_component_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/indices-component-template.html>`_
    ...
    def delete_voting_config_exclusions(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/voting-config-exclusions.html>`_
    ...
    def get_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-get-settings.html>`_
    ...
    def health(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-health.html>`_
    ...
    def pending_tasks(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-pending.html>`_
    ...
    def put_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-update-settings.html>`_
    ...
    def remote_info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-remote-info.html>`_
        """
        __path = "/_remote/info"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    def reroute(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-reroute.html>`_
    ...
    def state(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-state.html>`_
    ...
    def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/cluster-stats.html>`_
