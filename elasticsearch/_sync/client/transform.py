...
class TransformClient(NamespacedClient):
    ...
    def delete_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/delete-transform.html>`_
    ...
    def get_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/get-transform.html>`_
    ...
    def get_transform_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/get-transform-stats.html>`_
    ...
    def preview_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/preview-transform.html>`_
    ...
    def put_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/put-transform.html>`_
    ...
    def reset_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/reset-transform.html>`_
    ...
    def start_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/start-transform.html>`_
    ...
    def stop_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/stop-transform.html>`_
    ...
    def update_transform(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/update-transform.html>`_
    ...
    def upgrade_transforms(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/upgrade-transforms.html>`_
