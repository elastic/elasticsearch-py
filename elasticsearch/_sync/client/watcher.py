...
class WatcherClient(NamespacedClient):
    ...
    def ack_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-ack-watch.html>`_
    ...
    def activate_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-activate-watch.html>`_
    ...
    def deactivate_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-deactivate-watch.html>`_
    ...
    def delete_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-delete-watch.html>`_
    ...
    def execute_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-execute-watch.html>`_
    ...
    def get_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-get-watch.html>`_
    ...
    def put_watch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-put-watch.html>`_
    ...
    def query_watches(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-query-watches.html>`_
    ...
    def start(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-start.html>`_
        """
    ...
    def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-stats.html>`_
    ...
    def stop(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.7/watcher-api-stop.html>`_
        """
