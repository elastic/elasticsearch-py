...
class SearchableSnapshotsClient(NamespacedClient):
    ...
    def cache_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/searchable-snapshots-apis.html>`_
    ...
    def mount(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/searchable-snapshots-api-mount-snapshot.html>`_
