...
class SecurityClient(NamespacedClient):
    ...
    def activate_user_profile(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-activate-user-profile.html>`_
    ...
    def authenticate(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-authenticate.html>`_
        """
    ...
    def change_password(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-change-password.html>`_
    ...
    def clear_api_key_cache(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-clear-api-key-cache.html>`_
    ...
    def clear_cached_privileges(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-clear-privilege-cache.html>`_
    ...
    def clear_cached_realms(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-clear-cache.html>`_
    ...
    def clear_cached_roles(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-clear-role-cache.html>`_
    ...
    def clear_cached_service_tokens(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-clear-service-token-caches.html>`_
    ...
    def create_api_key(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-create-api-key.html>`_
    ...
    def create_service_token(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-create-service-token.html>`_
    ...
    def delete_privileges(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-delete-privilege.html>`_
    ...
    def delete_role(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-delete-role.html>`_
    ...
    def delete_role_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-delete-role-mapping.html>`_
    ...
    def delete_service_token(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-delete-service-token.html>`_
    ...
    def delete_user(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-delete-user.html>`_
    ...
    def disable_user(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-disable-user.html>`_
    ...
    def disable_user_profile(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-disable-user-profile.html>`_
    ...
    def enable_user(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-enable-user.html>`_
    ...
    def enable_user_profile(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-enable-user-profile.html>`_
    ...
    def enroll_kibana(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-kibana-enrollment.html>`_
        """
    ...
    def enroll_node(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-node-enrollment.html>`_
        """
    ...
    def get_api_key(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-api-key.html>`_
    ...
    def get_builtin_privileges(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-builtin-privileges.html>`_
        """
    ...
    def get_privileges(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-privileges.html>`_
    ...
    def get_role(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-role.html>`_
    ...
    def get_role_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-role-mapping.html>`_
    ...
    def get_service_accounts(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-service-accounts.html>`_
    ...
    def get_service_credentials(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-service-credentials.html>`_
    ...
    def get_token(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-token.html>`_
    ...
    def get_user(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-user.html>`_
    ...
    def get_user_privileges(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-user-privileges.html>`_
    ...
    def get_user_profile(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-get-user-profile.html>`_
    ...
    def grant_api_key(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-grant-api-key.html>`_
    ...
    def has_privileges(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-has-privileges.html>`_
    ...
    def has_privileges_user_profile(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-has-privileges-user-profile.html>`_
    ...
    def invalidate_api_key(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-invalidate-api-key.html>`_
    ...
    def invalidate_token(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-invalidate-token.html>`_
    ...
    def put_privileges(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-put-privileges.html>`_
    ...
    def put_role(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-put-role.html>`_
    ...
    def put_role_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-put-role-mapping.html>`_
    ...
    def put_user(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-put-user.html>`_
    ...
    def query_api_keys(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-query-api-key.html>`_
    ...
    def saml_authenticate(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-saml-authenticate.html>`_
    ...
    def saml_complete_logout(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-saml-complete-logout.html>`_
    ...
    def saml_invalidate(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-saml-invalidate.html>`_
    ...
    def saml_logout(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-saml-logout.html>`_
    ...
    def saml_prepare_authentication(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-saml-prepare-authentication.html>`_
    ...
    def saml_service_provider_metadata(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-saml-sp-metadata.html>`_
    ...
    def suggest_user_profiles(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-suggest-user-profile.html>`_
    ...
    def update_api_key(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-update-api-key.html>`_
    ...
    def update_user_profile_data(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.6/security-api-update-user-profile-data.html>`_
