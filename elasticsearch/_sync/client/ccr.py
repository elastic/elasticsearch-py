...
class CcrClient(NamespacedClient):
    ...
    def resume_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-ccr-resume-auto-follow-pattern>`_
    ...
    def resume_follow(
        ...
        *,
        ...
        `<https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-ccr-resume-follow>`_
    ...
    def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-ccr-stats>`_
    ...
    def unfollow(
        ...
        *,
        ...
        `<https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-ccr-unfollow>`_
