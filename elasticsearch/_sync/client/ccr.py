...
class CcrClient(NamespacedClient):
    ...
    def delete_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-delete-auto-follow-pattern.html>`_
    ...
    def follow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-put-follow.html>`_
    ...
    def follow_info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-get-follow-info.html>`_
    ...
    def follow_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-get-follow-stats.html>`_
    ...
    def forget_follower(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-post-forget-follower.html>`_
    ...
    def get_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-get-auto-follow-pattern.html>`_
    ...
    def pause_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-pause-auto-follow-pattern.html>`_
    ...
    def pause_follow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-post-pause-follow.html>`_
    ...
    def put_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-put-auto-follow-pattern.html>`_
    ...
    def resume_auto_follow_pattern(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-resume-auto-follow-pattern.html>`_
    ...
    def resume_follow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-post-resume-follow.html>`_
    ...
    def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-get-stats.html>`_
        """
        __path = "/_ccr/stats"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    def unfollow(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.8/ccr-post-unfollow.html>`_
