...
class Elasticsearch(BaseClient):
    ...
    def bulk(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-bulk.html>`_
    ...
    def clear_scroll(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/clear-scroll-api.html>`_
    ...
    def close_point_in_time(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/point-in-time-api.html>`_
    ...
    def count(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-count.html>`_
    ...
    def create(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-index_.html>`_
    ...
    def delete(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-delete.html>`_
    ...
    def delete_by_query(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-delete-by-query.html>`_
    ...
    def delete_script(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/modules-scripting.html>`_
    ...
    def explain(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-explain.html>`_
    ...
    def field_caps(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-field-caps.html>`_
    ...
    def get_script_context(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/painless/8.4/painless-contexts.html>`_
        """
    ...
    def info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/index.html>`_
        """
        __path = "/"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    def knn_search(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-search.html>`_
    ...
    def mget(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-multi-get.html>`_
    ...
    def msearch(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-multi-search.html>`_
    ...
    def mtermvectors(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-multi-termvectors.html>`_
    ...
    def rank_eval(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-rank-eval.html>`_
    ...
    def reindex(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-reindex.html>`_
    ...
    def render_search_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/render-search-template-api.html>`_
    ...
    def scripts_painless_execute(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/painless/8.4/painless-execute-api.html>`_
    ...
    def scroll(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-request-body.html#request-body-search-scroll>`_
    ...
    def search_mvt(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-vector-tile-api.html>`_
    ...
    def search_shards(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-shards.html>`_
    ...
    def search_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-template.html>`_
    ...
    def terms_enum(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/search-terms-enum.html>`_
    ...
    def termvectors(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-termvectors.html>`_
    ...
    def update(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-update.html>`_
    ...
    def update_by_query(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/docs-update-by-query.html>`_
