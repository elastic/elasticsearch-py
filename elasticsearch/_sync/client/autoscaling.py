...
class AutoscalingClient(NamespacedClient):
    ...
    def delete_autoscaling_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/autoscaling-delete-autoscaling-policy.html>`_
    ...
    def get_autoscaling_capacity(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/autoscaling-get-autoscaling-capacity.html>`_
        """
    ...
    def put_autoscaling_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.2/autoscaling-put-autoscaling-policy.html>`_
