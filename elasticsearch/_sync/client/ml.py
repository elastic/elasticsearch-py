...
class MlClient(NamespacedClient):
    ...
    def get_calendar_events(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-calendar-event.html>`_
    ...
    def get_calendars(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-calendar.html>`_
    ...
    def get_categories(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-category.html>`_
    ...
    def get_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/get-dfanalytics.html>`_
    ...
    def get_data_frame_analytics_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/get-dfanalytics-stats.html>`_
    ...
    def get_datafeed_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-datafeed-stats.html>`_
    ...
    def get_datafeeds(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-datafeed.html>`_
    ...
    def get_filters(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-filter.html>`_
    ...
    def get_influencers(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-influencer.html>`_
    ...
    def get_job_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-job-stats.html>`_
    ...
    def get_jobs(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-job.html>`_
    ...
    def get_memory_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/get-ml-memory.html>`_
    ...
    def get_model_snapshot_upgrade_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-job-model-snapshot-upgrade-stats.html>`_
    ...
    def get_model_snapshots(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-snapshot.html>`_
    ...
    def get_overall_buckets(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-overall-buckets.html>`_
    ...
    def get_records(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-get-record.html>`_
    ...
    def get_trained_models(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/get-trained-models.html>`_
    ...
    def get_trained_models_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/get-trained-models-stats.html>`_
    ...
    def infer_trained_model(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/infer-trained-model.html>`_
    ...
    def info(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/get-ml-info.html>`_
        """
        __path = "/_ml/info"
        __query: t.Dict[str, t.Any] = {}
        if error_trace is not None:
    ...
    def open_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-open-job.html>`_
    ...
    def post_calendar_events(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-post-calendar-event.html>`_
    ...
    def post_data(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-post-data.html>`_
    ...
    def preview_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/preview-dfanalytics.html>`_
    ...
    def preview_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-preview-datafeed.html>`_
    ...
    def put_calendar(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-put-calendar.html>`_
    ...
    def put_calendar_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-put-calendar-job.html>`_
    ...
    def put_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/put-dfanalytics.html>`_
    ...
    def put_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-put-datafeed.html>`_
    ...
    def put_filter(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-put-filter.html>`_
    ...
    def put_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-put-job.html>`_
    ...
    def put_trained_model(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/put-trained-models.html>`_
    ...
    def put_trained_model_alias(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/put-trained-models-aliases.html>`_
    ...
    def put_trained_model_definition_part(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/put-trained-model-definition-part.html>`_
    ...
    def put_trained_model_vocabulary(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/put-trained-model-vocabulary.html>`_
    ...
    def reset_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-reset-job.html>`_
    ...
    def revert_model_snapshot(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-revert-snapshot.html>`_
    ...
    def set_upgrade_mode(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-set-upgrade-mode.html>`_
    ...
    def start_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/start-dfanalytics.html>`_
    ...
    def start_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-start-datafeed.html>`_
    ...
    def start_trained_model_deployment(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/start-trained-model-deployment.html>`_
    ...
    def stop_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/stop-dfanalytics.html>`_
    ...
    def stop_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-stop-datafeed.html>`_
    ...
    def stop_trained_model_deployment(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/stop-trained-model-deployment.html>`_
    ...
    def update_data_frame_analytics(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/update-dfanalytics.html>`_
    ...
    def update_datafeed(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-update-datafeed.html>`_
    ...
    def update_filter(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-update-filter.html>`_
    ...
    def update_job(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-update-job.html>`_
    ...
    def update_model_snapshot(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-update-snapshot.html>`_
    ...
    def upgrade_job_snapshot(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.4/ml-upgrade-job-model-snapshot.html>`_
    ...
    def validate(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/machine-learning/8.4/ml-jobs.html>`_
