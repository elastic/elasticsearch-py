...
class EnrichClient(NamespacedClient):
    ...
    def delete_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/delete-enrich-policy-api.html>`_
    ...
    def execute_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/execute-enrich-policy-api.html>`_
    ...
    def get_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/get-enrich-policy-api.html>`_
    ...
    def put_policy(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/put-enrich-policy-api.html>`_
    ...
    def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.1/enrich-stats-api.html>`_
        """
