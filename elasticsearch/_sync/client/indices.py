...
class IndicesClient(NamespacedClient):
    ...
    def add_block(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/index-modules-blocks.html>`_
    ...
    def analyze(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-analyze.html>`_
    ...
    def clear_cache(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-clearcache.html>`_
    ...
    def clone(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-clone-index.html>`_
    ...
    def close(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-open-close.html>`_
    ...
    def create(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-create-index.html>`_
    ...
    def create_data_stream(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/data-streams.html>`_
    ...
    def delete(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-delete-index.html>`_
    ...
    def delete_alias(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-aliases.html>`_
    ...
    def delete_index_template(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-templates.html>`_
    ...
    def disk_usage(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-disk-usage.html>`_
    ...
    def exists(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-exists.html>`_
    ...
    def field_usage_stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/field-usage-stats.html>`_
    ...
    def flush(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-flush.html>`_
    ...
    def forcemerge(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-forcemerge.html>`_
    ...
    def get(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-get-index.html>`_
    ...
    def get_field_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-get-field-mapping.html>`_
    ...
    def get_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-get-mapping.html>`_
    ...
    def get_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-get-settings.html>`_
    ...
    def put_mapping(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-put-mapping.html>`_
    ...
    def put_settings(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-update-settings.html>`_
    ...
    def recovery(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-recovery.html>`_
    ...
    def refresh(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-refresh.html>`_
    ...
    def reload_search_analyzers(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-reload-analyzers.html>`_
    ...
    def resolve_index(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-resolve-index-api.html>`_
    ...
    def rollover(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-rollover-index.html>`_
    ...
    def segments(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-segments.html>`_
    ...
    def shard_stores(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-shards-stores.html>`_
    ...
    def shrink(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-shrink-index.html>`_
    ...
    def split(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-split-index.html>`_
    ...
    def stats(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/indices-stats.html>`_
    ...
    def unfreeze(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/unfreeze-index-api.html>`_
    ...
    def validate_query(
        ...
        *,
        ...
        `<https://www.elastic.co/guide/en/elasticsearch/reference/8.3/search-validate.html>`_
